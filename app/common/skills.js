  ...
  const skills = [
    {
      title: "MongoDB",
      description:
        "Proficient in designing and managing NoSQL databases, including data modeling and CRUD operations.",
    },
    {
      title: "Express.js",
      description:
        "Experienced in building robust, RESTful APIs and server-side applications using Express.js.",
    },
    {
      title: "React",
      description:
        "Skilled in creating dynamic and responsive user interfaces with React, including state management and component-based architecture.",
    },
    {
      title: "Node.js",
      description:
        "Capable of developing server-side applications, real-time features, and backend services using Node.js.",
    },
  ];
  const languages = [
    ...
    <div className="2xl:container grid mx-auto">
      <div className=" md:px-36">
        <div className="flex flex-col items-center justify-center">
          <h5
            data-aos="fade-up"
            className="text-primary pt-6 plusJakara_medium text-4xl resume_ "
          >
            Skills
          </h5>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 justify-center  py-9">
          <div>
            ...
            >
              ...
              <p className="mb-4 plusJakara_light">
                I specialize in MERN Stack web development, encompassing the
                following technologies:
              </p>
              <ul className="list-disc p-0 space-y-2">
                {skills.map((skill, index) => (
                  <li key={index}>
                    <strong>{skill.title}:</strong>
                    <p className="plusJakara_light">{skill.description}</p>
                  </li>
                ))}
              </ul>
              <p className="mt-4 plusJakara_light">
                Additionally, I have a strong foundation in related web
                technologies, such as HTML, CSS, JavaScript and TypeScript,
                which complements my MERN Stack expertise. My experience in this
                stack enables me to deliver efficient and modern web
                applications.
              </p>
            </div>
          </div>
